<proyecto version ='2' nombre='alu4-nf'>
	...
	<componentes version='1' nombre='alu4-nf' tipo='main'>
		<componente>
			<nombre>Punto</nombre>
			<centro x='60' y='90'/>
			<lado>10</lado>
		...
		<componente>
			...
			<lado>100</lado>
			<grados>0</grados>
			<nombre_especifico>alu1</nombre_especifico>
			...
			<mapeo_entrada clave='ci-1' valor='5'/>
			<mapeo_entrada clave='Compl-1' valor='4'/>
			<mapeo_entrada clave='op1' valor='2'/>
			<mapeo_entrada clave='op0' valor='3'/>
