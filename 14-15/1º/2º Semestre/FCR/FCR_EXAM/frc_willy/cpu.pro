<proyecto version ='2' nombre='cpu'>
	...
	<circuito url='' nombre='reg4'/>
	<circuito url='' nombre='sum1'/>
	<componentes version='1' nombre='cpu' tipo='main'>
		<componente>
