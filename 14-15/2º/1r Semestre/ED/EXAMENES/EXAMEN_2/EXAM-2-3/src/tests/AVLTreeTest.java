...
public class AVLTreeTest {
	...
	public void removeTest() throws Exception
	{
		...
		e.remove('d');
		assertEquals ("b(0)a(0)--c(0)--", e.toString());
		System.out.println("Current working tree: "+e.toString()+"\n");
	...
	public void updateHeightTest() throws Exception
	{
		...
		assertEquals (1, f.getRoot().getLeft().getHeight());
		...
		f.add('c');
		assertEquals (3, f.getRoot().getHeight());
		assertEquals (1, f.getRoot().getLeft().getHeight());
		assertEquals (2, f.getRoot().getRight().getHeight());
		assertEquals (1, f.getRoot().getRight().getLeft().getHeight());
	...
	public void getBFTest() throws Exception
	{
		...
		g.add('g');
		assertEquals (1, g.getRoot().getBF());
		assertEquals ("b("+g.getRoot().getBF()+")a(0)--f(0)c(0)--g(0)--", g.toString());
		System.out.println("Current working tree: "+g.toString()+"\n");
	...
	public void joinTest() throws Exception
	{
		...
		System.out.println("------------- Ending OK the joinTest() method -------------\n");
	}
	
	@Test 
	public void singleLeftRotation() throws Exception
	{
		System.out.println("------------- Inicializing the singleLeftRotation() method -------------\n");
		//Creating a tree.
		AVLTree<Character> a = new AVLTree<Character>();
		...
		System.out.println("------------- Ending OK the singleLeftRotation() method -------------\n");
	}

	@Test
	public void getHeightTest() throws Exception
	{
		System.out.println("------------- Inicializing the getHeightTest() method -------------\n");
		
		//Creating some trees.
		AVLTree<Character> a = new AVLTree<Character>();
		AVLTree<Integer> b = new AVLTree<Integer>();
		AVLTree<Integer> c = new AVLTree<Integer>();
		AVLTree<String> d = new AVLTree<String>();
		AVLTree<String> e = new AVLTree<String>(); //This will be the empty tree.
				
		//Adding some nodes to the tree "a".
		a.add('b');
		a.add('a');
		a.add('d');
		a.add('c');
		...
		a.add('i');
		a.add('h');
		assertEquals("d(0)b(0)a(0)--c(0)--h(0)e(0)--i(0)--", a.toString());
		
		//Adding some nodes to the tree "b".
		b.add(1);
		b.add(2);
		b.add(3);
		b.add(4);
		...
		b.add(6);
		b.add(7);
		assertEquals("4(0)2(0)1(0)--3(0)--6(0)5(0)--7(0)--", b.toString());
		
		//Adding some nodes to the tree "c".
		c.add(7);
		c.add(6);
		c.add(5);
		c.add(4);
		...
		c.add(2);
		c.add(1);
		assertEquals("4(0)2(0)1(0)--3(0)--6(0)5(0)--7(0)--", c.toString());
		
		//Adding one node to the "d" tree.
		d.add("AAA");
		assertEquals("AAA(0)--", d.toString());
		
		//The "e" node will remain empty
		assertEquals("-", e.toString());
		
		//Representing the trees.
		System.out.println("Current working tree: "+a.toString()+"\n");
		System.out.println("Current working tree: "+b.toString()+"\n");
		System.out.println("Current working tree: "+c.toString()+"\n");
		System.out.println("Current working tree: "+d.toString()+"\n");
		System.out.println("Current working tree: "+e.toString()+"\n");
		
		//Testing the getHeight() for the a tree.
		...
		System.out.println("------------- Ending OK the getHeightTest() method -------------\n");
	}
}
