...
public class HashTable<T extends Comparable <T>> {
	...
	*/
	...
	/**
	 * Search. Given an element it checks if it is in the possition it should be.
	 * 
	 * @param element
	...
	/**
	 * Public dynamic resizing method. It calls to another with 2*B as a parameter.
	 */
