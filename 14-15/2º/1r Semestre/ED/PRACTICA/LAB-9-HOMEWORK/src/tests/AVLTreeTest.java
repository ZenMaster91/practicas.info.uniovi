...
public class AVLTreeTest {
	...
	public void getHeightTest() throws Exception
	{
		...
		a.add('i');
		a.add('h');
		assertEquals("b(3)a(0)--d(2)c(0)--e(0)-i(-1)h(0)---", a.toString());
		...
		b.add(6);
		b.add(7);
		assertEquals("1(6)-2(5)-3(4)-4(3)-5(2)-6(1)-7(0)--", b.toString());
		...
		c.add(2);
		c.add(1);
		assertEquals("7(-6)6(-5)5(-4)4(-3)3(-2)2(-1)1(0)--------", c.toString());
